...
static CGFloat const PLAYER_VIEW_HEIGHT=45.0f;
static CGFloat const PLAYER_ANIMATION_DURATION=0.3f;
...
@property (nonatomic,assign)BOOL isFullMenu;
...
@property (nonatomic, assign) BOOL isSmallPlayerViewHidden;
@property (nonatomic, assign) BOOL isSmallPlayerViewHideAnimating;
@property (nonatomic, assign)           BOOL                isPlayerViewSmall;
