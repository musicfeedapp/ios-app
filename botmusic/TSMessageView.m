...
- (CGFloat)updateHeightOfMessageView
{
    ...
    self.titleLabel.frame = CGRectMake(_titleLabel.frame.origin.x, _titleLabel.frame.origin.y - 10.0, _titleLabel.frame.size.width, _titleLabel.frame.size.height);
